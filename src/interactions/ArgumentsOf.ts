import { ApplicationCommandOptionType, type ApplicationCommandType } from "discord-api-types/v10";
import type { Attachment, GuildChannel, GuildMember, Role, Message, User } from "discord.js";
